...
/**
 * Event handler invoked when a technology research timer completes.
 */
class ResearchCompleteHandler : public openage::event::OnceEventHandler {
public:
	ResearchCompleteHandler();
	~ResearchCompleteHandler() override = default;
