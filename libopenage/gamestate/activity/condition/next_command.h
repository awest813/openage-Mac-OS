 ...
 * @param entity Game entity.
 *
 * @return true if the entity has an attack command next in the queue, false otherwise.
 */
bool next_command_attack(const time::time_t &time,
                         const std::shared_ptr<gamestate::GameEntity> &entity);
 ...
 * @param entity Game entity.
 *
 * @return true if the entity has a gather command next in the queue, false otherwise.
 */
 ...
 * @param entity Game entity.
 *
 * @return true if the entity has a formation-move command next in the queue, false otherwise.
 */
