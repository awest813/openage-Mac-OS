...
def tests_cpp():
    ...
    yield "openage::gamestate::tests::entity_max_hp_tracking"
    yield "openage::gamestate::tests::repair_command_lifecycle"
    yield "openage::gamestate::tests::repair_approach_movement"
    yield "openage::gamestate::tests::garrison_lifecycle"
    yield "openage::gamestate::tests::garrison_capacity_and_ownership"
    yield "openage::gamestate::tests::garrison_arrow_bonus_and_damage"
    yield "openage::gamestate::tests::town_bell_and_back_to_work"
    yield "openage::gamestate::tests::garrison_passive_heal"
    yield "openage::gamestate::tests::combat_melee_and_pierce_armor"
    yield "openage::gamestate::tests::combat_attack_bonuses"
    yield "openage::gamestate::tests::combat_elevation_modifier"
    yield "openage::gamestate::tests::combat_minimum_range"
    yield "openage::gamestate::tests::combat_siege_splash_damage"
    yield "openage::gamestate::tests::market_commodity_buy_and_sell"
    yield "openage::gamestate::tests::market_dynamic_price_fluctuations"
    yield "openage::gamestate::tests::market_fee_customization"
    yield "openage::gamestate::tests::market_tribute_system_and_fees"
    yield "openage::gamestate::tests::trade_cart_gold_distance_formula"
    yield "openage::gamestate::tests::trade_cart_continuous_trading_loop_and_market_destruction"
    yield "openage::gamestate::tests::player_age_progression_lifecycle"
    yield "openage::gamestate::tests::research_queue_cost_and_prerequisites"
    yield "openage::gamestate::tests::research_cancellation_and_full_refund"
    yield "openage::gamestate::tests::research_completion_and_age_advancement"
    yield "openage::gamestate::tests::technology_effect_application"
    yield "openage::gamestate::tests::research_building_destruction_handling"
